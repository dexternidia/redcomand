...
--
-- Servidor: localhost
-- Tiempo de generación: 14-09-2017 a las 15:41:33
...
CREATE TABLE IF NOT EXISTS `pasos` (
  ...
  `solicitud_id` int(11) NOT NULL,
  `eliminar` int(1) NOT NULL,
  `fecha_hora_registro` varchar(50) NOT NULL,
  `fecha_hora_asignado_consignado` varchar(50) NOT NULL,
  `fecha_hora_registro_cerrado` varchar(50) NOT NULL,
...
(11, 2, 1, 'V', 17997299, 'NIDIA YUDITH DIAZ BRACHE', 0, 0, 'elmorochez22@gmail.com', 'CAMBIO- CAMBIO 2', 'AV D', 'S/N', '1987-11-13', '2017-09-14', '15:01:08', 0),
(12, 5, 14, 'V', 19881315, 'Silva Guevara Carlos Hugo', 0, 0, '', 'SECTOR 2', '23', '03', '1989-5-30', '2017-09-14', '15:04:54', 0),
(13, 5, 20, 'V', 11708439, 'CARLOS MIGUEL LEON GARRIDO', 0, 2147483647, 'leon@gmail.com', 'CIUDAD TAVACARE, SECTOR C, TERRAZA 1', 'BLOQUE 24', 'APTO 24', '1973-12-16', '2017-09-14', '15:10:12', 0),
(14, 5, 19, 'V', 19881316, 'Silva Guevara Carlos Daniel', 2147483647, 0, '', 'SECTOR 2', '23', '03', '1989-5-30', '2017-09-14', '15:30:23', 0);
...
INSERT INTO `solicitudes` (`id`, `solicitante_id`, `tipo_solicitud_id`, `requerimiento_categoria_id`, `organismo_id`, `fecha_hora_registrado`, `fecha_hora_consignado`, `fecha_hora_asignado`, `fecha_hora_procesado`, `observacion`, `estatus`, `eliminar`) VALUES
(1, 1, 3, 1, 1, '2017-09-14 11:49:22', '', '', '', '', 2, 0),
(2, 12, 3, 1, 1, '2017-09-14 15:08:09', '', '', '', '', 2, 0);
