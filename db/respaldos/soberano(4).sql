...
--
-- Servidor: localhost
-- Tiempo de generación: 13-09-2017 a las 16:17:29
...
`id` int(11) NOT NULL,
  ...
  `tipo_requerimiento_id` int(11) NOT NULL,
...
INSERT INTO `detalle_solicitud` (`id`, `solicitud_id`, `tipo_requerimiento_id`, `requerimiento_categoria_id`, `requerimiento_id`, `observacion`, `consignado`, `eliminar`) VALUES
(1, 1, 1, 0, 0, '/imi/carata.jpg', 1, 0),
(2, 1, 2, 0, 0, 'nota: aslñda{ldad', 1, 0);
...
(11, 5, 16, 'V', 19952334, 'JAIR ALBERTO CARDENAS', '02735338034', '04127624857', 'elmorochez22@gmail.com', 'CAMBIO- CAMBIO 2', 'AV D', 'S/N', '1978-6-17', '2017-09-13', '11:31:20', 0),
(12, 5, 20, 'V', 11708439, 'MILAGROS CAROLINA NASO MANZANO', '', '12233325522', '', 'LAS PALMAS ROSA MISTICA', 'CALLE 2', 'CASA 19', '1976-10-27', '2017-09-13', '12:58:55', 0),
(13, 5, 20, 'V', 17549520, 'YOLMARIS ANDREINAdsfds RIVERO CONTRERAS', '', '5456544646', '', 'CIUDAD TAVACARE, SECTOR C, TERRAZA 1', 'BLOQUE 24', 'APTO 24', '1985-10-7', '2017-09-13', '13:03:59', 0),
(14, 5, 16, 'V', 28487639, 'BRAYANTH DANIEL GIRALDO DIAZ', '02735338034', '04127624857', 'elmorochez22@gmail.com', 'CAMBIO- CAMBIO 2', 'AV D', 'S/N', '2001-12-1', '2017-09-13', '14:21:42', 0),
(15, 5, 19, 'V', 19881315, 'Silva Guevara Carlos Hugo', '02735338034', '04127624857', 'elmorochez22@gmail.com', 'SECTOR 2', '23', '03', '1989-5-30', '2017-09-13', '16:03:31', 0);
...
INSERT INTO `solicitudes` (`id`, `solicitante_id`, `tipo_solicitud_id`, `requerimiento_categoria_id`, `organismo_id`, `fecha`, `observacion`, `estatus`, `eliminar`) VALUES
(1, 5, 1, 0, 1, '30-05-2017', '', 2, 0),
(2, 5, 1, 0, 1, '', '', 0, 0),
(3, 15, 3, 1, 1, '', '', 0, 0);
