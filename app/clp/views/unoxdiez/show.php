<div id="panel" class="panel panel-primary">
  <div class="panel-heading" style="background-color: red">
    ...
    <a class="btn btn-default pull-right" href="<?php echo baseUrlRole() ?>unoxdiezintegrantes/create/<?php echo $padrino->id_ubch_registro_unoxdiez ?>"><i class="fa fa-plus-square text-muted"></i><i style="color:#777;"> Agregar Ahijado</i></a>    </h3>
  </div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="text-align: center;" width="5%">
              <?php echo Token() ?>
              <a class="text-danger fa fa-times fa-1x" href="<?php echo baseUrlRole() ?>unoxdiezintegrantes/<?php echo $u->id_ubch_registro_unoxdiez_integrantes ?>/delete?id_ubch_registro_unoxdiez=<?php echo $u->id_ubch_registro_unoxdiez ?>"></a>
            </td>
          </tr>
          <?php endforeach ?>
        </tbody>
