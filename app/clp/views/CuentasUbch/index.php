<div id="panel" class="panel panel-primary">
  <div class="panel-heading" style="background-color: red">
    ...
    <a class="btn btn-default pull-right" href="<?php echo baseUrlRole() ?>CuentasUbch/create"><i class="fa fa-plus-square text-muted"></i><i style="color:#777;"> CREAR CUENTA</i></a>    </h3>
  </div>
