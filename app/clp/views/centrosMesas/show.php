      ...
      <div class="col-lg-6 animated fadeIn animated">
        <div class="col-lg-12">
          <div class="">
            ...
            <a class="btn btn-default pull-right" href="<?php echo baseUrlRole() ?>centrosProblematicas/<?php echo $mesa->id_mesas_ubch ?>/delete"><i class="fa fa-times text-danger"></i></a>
            <a class="btn btn-default pull-right" href="<?php echo baseUrlRole() ?>centrosProblematicas/<?php echo $mesa->id_mesas_ubch ?>/edit"><i class="fa fa-pencil text-primary"></i></a>
            </h5>
            <hr>
          </div>
          <div class="">
