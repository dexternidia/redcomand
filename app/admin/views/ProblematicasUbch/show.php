      ...
      <div class="col-lg-6 animated fadeIn animated">
        <div class="col-lg-12">
          <div class="">
            ...
            <a class="btn btn-default pull-right" href="<?php echo baseUrlRole() ?>ProblematicasUbch/<?php echo $problema->id_problema ?>/delete"><i class="fa fa-times text-danger"></i></a>
            <a class="btn btn-default pull-right" href="<?php echo baseUrlRole() ?>ProblematicasUbch/<?php echo $problema->id_problema ?>/edit"><i class="fa fa-pencil text-primary"></i></a>
            </h5>
            <hr>
          </div>
          <div class="">
