...
//alert(idMunicipio);
$.get("<?php echo baseUrlRole() ?>RegistroClp/parroquiasCne", { idMunicipio:idMunicipio }, function(data){
...
//alert(idParroquia);
$.get("<?php echo baseUrlRole() ?>RegistroClp/mesasCne", { idParroquia:idParroquia }, function(data){
...
<div id="panel" class="panel panel-primary">
  <div class="panel-heading" style="background-color: red">
    <h3 class="panel-title text-muted"><i class="fa fa-wpexplorer fa-2x"></i> INGRESAR CLP</h3>
  </div>
  <br>
  <div class="panel-body">
    <form action="<?php echo baseUrlRole() ?>RegistroClp" method="POST">
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="form-group">
            <input class="form-control" type="text" name="nombre" placeholder="NOMBRE CLP">
          </div>
        </div>
        <div class="col-lg-12">
