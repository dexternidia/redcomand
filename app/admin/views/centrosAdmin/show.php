      ...
      <div class="col-lg-6 animated fadeIn animated">
        <div class="col-lg-12">
          <div class="">
            ...
            <a class="btn btn-default pull-right" href="<?php echo baseUrlRole() ?>ResponsableUbchAdmin/create/<?php echo $ubch->id ?>"><i class="fa fa-times text-danger"></i></a>
            <a class="btn btn-default pull-right" href="<?php echo baseUrlRole() ?>ResponsableUbchAdmin/create/<?php echo $ubch->id ?>"><i class="fa fa-pencil text-primary"></i></a>
            </h5>
            <br>
          </div>
          <div class="">
      ...
      <div class="col-lg-6 animated fadeIn animated">
        <div class="col-lg-12">
          ...
          <div class="">
            ...
            <a class="btn btn-danger" href="<?php echo baseUrlRole() ?>centrosResponsablesAdmin/busqueda/<?php echo $ubch->id_ubch ?>"><i class="fa fa-user-plus"></i> Agregar Responsable UBCH</a>
          </div>
        </div>
      </div>
      <?php endif ?>
      ...
      <div class="col-lg-6 animated fadeIn animated">
        <div class="col-lg-12">
          <div class="">
            ...
            <a class="btn btn-default pull-right" href="<?php echo baseUrlRole() ?>centrosProblematicasAdmin/create/<?php echo $ubch->id_ubch ?>"><i class="fa fa-plus text-primary"></i></a>
            </h5>
            <br>
          </div>
            ...
            <table id="myTable" class="table table-striped table-condensed animated fadeIn" data-striped="true">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td width="5%">
                    <?php echo Token() ?>
                    <a class="text-danger fa fa-search fa-1x pull-right" href="<?php echo baseUrlRole() ?>centrosProblematicasAdmin/<?php echo $u->id_problematica_ubch ?>" onclick="this.parentNode.submit(); return false;"></a>
                  </td>
                </tr>
                <?php endforeach ?>
              </tbody>
      ...
      <div class="col-lg-6 animated fadeIn animated">
        <div class="col-lg-12">
          <div class="">
            ...
            <a class="btn btn-default pull-right" href="<?php echo baseUrlRole() ?>centrosSolicitudesAdmin/create/<?php echo $ubch->id_ubch ?>"><i class="fa fa-plus text-primary"></i></a>
            </h5>
            <br>
          </div>
          <div class="col-md-12 table-responsive panel panel-default">
            <table id="myTable" class="table table-striped table-condensed animated fadeIn" data-striped="true">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td width="5%">
                    <?php echo Token() ?>
                    <a class="text-danger fa fa-search fa-1x pull-right" href="<?php echo baseUrlRole() ?>centrosSolicitudesAdmin/<?php echo $u->id_solicitud_ubch ?>" onclick="this.parentNode.submit(); return false;"></a>
                  </td>
                </tr>
                <?php endforeach ?>
              </tbody>
            ...
            <table id="myTable" class="table table-striped table-condensed animated fadeIn" data-striped="true">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td width="5%">
                    <?php echo Token() ?>
                    <a class="text-danger fa fa-search fa-1x pull-right" href="<?php echo baseUrlRole() ?>centrosMesasAdmin/<?php echo $u->id_mesas_ubch ?>" onclick="this.parentNode.submit(); return false;"></a>
                  </td>
                </tr>
                <?php endforeach ?>
              </tbody>
...
<!--       <div class="col-lg-6 animated fadeIn animated">
      ...
      <div class="col-lg-6 animated fadeIn animated">
        <div class="col-lg-12">
          <div class="">
            <h5 class="text-muted text-muted">
            <i class="fa fa-file"></i> 1X10 PADRINOS<a class="btn btn-default pull-right" href="<?php echo baseUrlRole() ?>unoxdiezAdmin/create/<?php echo $ubch->id_ubch ?>"><i class="fa fa-plus text-primary"></i></a>
            </h5>
            <br>
          </div>
          <div class="col-md-12 table-responsive panel panel-default">
            <table id="myTable" class="table table-striped table-condensed animated fadeIn" data-striped="true">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td width="5%">
                    <?php echo Token() ?>
                    <a class="text-danger fa fa-search fa-1x pull-right" href="<?php echo baseUrlRole() ?>unoxdiezAdmin/<?php echo $u->id_ubch_registro_unoxdiez ?>" onclick="this.parentNode.submit(); return false;"></a>
                  </td>
                </tr>
                <?php endforeach ?>
              </tbody>
