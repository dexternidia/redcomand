      ...
      <div class="col-lg-6 animated fadeIn animated">
        <div class="col-lg-12">
          <div class="">
            ...
            <a class="btn btn-default pull-right" href="<?php echo baseUrlRole() ?>centrosProblematicasAdmin/<?php echo $mesa->id_mesas_ubch ?>/delete"><i class="fa fa-times text-danger"></i></a>
            <a class="btn btn-default pull-right" href="<?php echo baseUrlRole() ?>centrosProblematicasAdmin/<?php echo $mesa->id_mesas_ubch ?>/edit"><i class="fa fa-pencil text-primary"></i></a>
            </h5>
            <hr>
          </div>
          <div class="">
      ...
      <div class="col-lg-6 animated fadeIn animated">
        <div class="col-lg-12">
          <div class="">
            ...
            <a class="btn btn-default pull-right" href="<?php echo baseUrlRole() ?>centrosTestigosAdmin/busqueda/<?php echo $mesa->id_mesas_ubch ?>"><i class="fa fa-plus text-primary"></i></a>
            </h5>
            <br>
          </div>
            ...
            <table id="myTable" class="table table-striped table-condensed animated fadeIn" data-striped="true">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td width="5%">
                    <?php echo Token() ?>
                    <a class="text-danger fa fa-times fa-1x pull-right" href="<?php echo baseUrlRole() ?>centrosTestigosAdmin/<?php echo $u->id_mesas_ubch_testigos ?>/delete?id_mesa=<?php echo $mesa->id_mesas_ubch ?>"></a>
                  </td>
                </tr>
                <?php endforeach ?>
              </tbody>
