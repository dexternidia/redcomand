...
class ResponsableUbch
{
    ...
    public function store()
    {
        ...
        if(!$responsable)
        {
            ...
            if($ubch->save())
            {
                Success('RegistroUbch/','Responsable de UBCH agregado con exito.');
            }
            else
            {
                Error('ResponsableUbch/','Error al ingresar Responsable de UBCH.');
            }
        }
        else
        {
            Error('RegistroUbch','Esta persona ya es responsable de un UBCH.');
        }
    }
