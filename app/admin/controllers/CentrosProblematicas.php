...
class CentrosProblematicasAdmin
{
    ...
    public function update($id)
    {
       ...
       //Arr($_POST); //Array para ver que envia el formulario
        ...
        if($problematica->save())
        {
            Success('centrosProblematicasAdmin/'.$problematica->id_problematica_ubch.'','Actulizada exitosamente la problematica.');
        }
        else
        {
            Error('centrosProblematicasAdmin/'.$problematica->id_problematica_ubch.'','Error al editar problematica.');
        }
    }
