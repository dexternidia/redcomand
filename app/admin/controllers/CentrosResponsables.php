...
class CentrosResponsablesAdmin
{
    ...
    public function create()
    {
        ...
        {
            Error('centrosAdmin/'.$id_ubch,'Esta persona ya es responsable de un centro.');
        }
        else
        {
    ...
    public function store()
    {
        ...
        if(!$responsable)
        {
            ...
            if($ubch->save())
            {
                ...
                if($usuario->save())
                {
                    Success('centrosAdmin/'.$id_ubch,'UBCH registrado, porceda a ingresar responsable.');
                }
                else
                {
                    Error('centrosAdmin/'.$id_ubch,'Error al ingresar Responsable de centro.');
                }
            }
            else
            {
    ...
    public function certificadoPDF()
    {
        extract($_GET);
        ob_start();
        include('app/admin/views/centrosResponsablesAdmin/certificadoPDF.php');
