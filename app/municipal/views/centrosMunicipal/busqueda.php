...
<div id="panel" class="panel panel-primary">
  ...
  <div class="panel-body">
    <form action="<?php echo baseUrlRole() ?>centrosMunicipal/create" method="POST">
      <?php echo Token::field() ?>
      <input type="hidden" name="id_clp" value="<?php echo $id_clp ?>">
      <input type="hidden" name="codigo_cne" value="<?php echo $codigo_cne ?>">
      <div class="row">
        <div class="col-lg-4">
          <div class="form-group">
            <input class="form-control" type="number" name="cedula" placeholder="CEDULA DE RESPONSABLE">
          </div>
        </div>
      </div>
      <div class="col-lg-12">
