        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="text-align: center;" width="5%">
              <?php echo Token() ?>
              <a class="text-danger fa fa-times fa-1x" href="<?php echo baseUrlRole() ?>unoxdiezintegrantesMunicipal/<?php echo $u->id_ubch_registro_unoxdiez_integrantes ?>/delete?id_ubch_registro_unoxdiez=<?php echo $u->id_ubch_registro_unoxdiez ?>"></a>
            </td>
          </tr>
          <?php endforeach ?>
        </tbody>
