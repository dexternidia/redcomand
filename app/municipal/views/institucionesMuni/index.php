      ...
      <table class="table table-striped table-condensed animated fadeIn" data-striped="true">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td width="5%">
              <form action="<?php echo baseUrlRole() ?>institucionesMuni/<?php echo $u->id_instituciones ?>/delete" method="POST">
                <?php echo Token() ?>
                <a class="text-primary fa fa-pencil fa-2x" href="<?php echo baseUrlRole() ?>institucionesMuni/<?php echo $u->id_instituciones ?>/edit"></a>
