...
class CentrosProblematicasMunicipal
{
    ...
    public function store()
    {
       ...
       //Arr($_POST); //Array para ver que envia el formulario
        ...
        {
            Success('centrosMunicipal/'.$id_ubch.'','Guardada existosamente...');
        }
        else
        {
             Error('centrosMunicipal/'.$id_ubch.'','Vuelva a intentarlo...');
        }
    }
    ...
    public function update($id)
    {
       ...
       //Arr($_POST); //Array para ver que envia el formulario
        ...
        if($problematica->save())
        {
            Success('centrosProblematicasMunicipal/'.$problematica->id_problematica_ubch.'','Actulizada exitosamente la problematica.');
        }
        else
        {
            Error('centrosProblematicasMunicipal/'.$problematica->id_problematica_ubch.'','Error al editar problematica.');
        }
    }
