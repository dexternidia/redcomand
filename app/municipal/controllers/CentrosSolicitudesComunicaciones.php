...
class CentrosSolicitudesComunicaciones
{
    ...
    public function store()
    {
        ...
        {
            Success('centrosMunicipal/'.$id_ubch.'','Solicitud ingresada con exito.');
        }
        else
        {
            Success('centrosMunicipal/'.$id_ubch.'','Error al insertar solicitud de comunicación.');
        }
    }
    ...
    public function destroy($id)
    {
        ...
        {
            Success('centrosMunicipal/'.$requerimientos->centro->id_ubch.'','Solicitud borrada con exito.');
        }
        else
        {
            Success('centrosMunicipal/'.$requerimientos->centro->id_ubch.'','Error al borrar la solicitud.');
        }
