...
class CentrosMunicipal
{
    ...
    public function store()
    {
        ...
        if(!$existeUbch)
        {
            ...
            if($ubch->save())
            {
                ...
                if($mesas_cne_conteo == $mesas_ubch_conteo)
                {
                    ...
                    if($mesa->save())
                    {
                        Success('centrosResponsablesMunicipal/busqueda/2'.$ubch->id,'UBCH registrado, porceda a ingresar responsable.');
                    }
                    else
                    {
                        ...
                        Error('centrosMunicipal/create','Error al ingresar ubch.');
                    }
                }
                else
                {
        ...
        {
            Error('centrosMunicipal/create','El Centro ya existe.');
        }
    }
