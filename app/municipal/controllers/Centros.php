...
class CentrosMunicipal
{
    ...
    public function busqueda()
    {
        ...
        $id_clp = Uri(5);
        $codigo_cne = Uri(6);
        View(compact('id_clp','codigo_cne'));
    }
    ...
    public function create()
    {
        ...
        if(!$responsable)
        {
            ...
            {
                Error('centrosMunicipal/busqueda/'.$id_clp.'/'.$codigo_cne,'No se encuentra registrado en el cne.');
            }
        }
        else
        {
            Error('centrosMunicipal/busqueda/'.$id_clp.'/'.$codigo_cne,'Esta persona ya es responsable de un centro.');
        }
    }
