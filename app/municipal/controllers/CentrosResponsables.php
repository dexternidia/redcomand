...
class CentrosResponsablesMunicipal
{
    ...
    public function create()
    {
        ...
        {
            Error('centrosMunicipal/'.$id_ubch,'Esta persona ya es responsable de un centro.');
        }
        else
        {
    ...
    public function store()
    {
        ...
        if(!$responsable)
        {
            ...
            if($ubch->save())
            {
                ...
                if($usuario->save())
                {
                    Success('centrosMunicipal/'.$id_ubch,'UBCH registrado, porceda a ingresar responsable.');
                }
                else
                {
                    Error('centrosMunicipal/'.$id_ubch,'Error al ingresar Responsable de centro.');
                }
            }
            else
            {
