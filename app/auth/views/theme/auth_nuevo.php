...
<html lang="en">
    <head>
        ...
        <style>
        html {
        background: url(http://permacultureconvergence.com.webserver.vera.asdf456.com/wp-content/uploads/2016/08/DiverseHands.jpg) no-repeat center center fixed;
    ...
    <body>
        <nav class="z-depth-2">
            <div class="nav-wrapper red darken-2 z-depth-2">
                ...
                <a style="font-family: 'Pacifico', cursive;font-size: 3.8em; text-shadow:0px 0px 1px #444;" href="#" class="brand-logo">Municipales 2017</a>
