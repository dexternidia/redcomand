...
<div id="panel" class="panel panel-primary">
  <div class="panel-heading" style="background-color: red">
    <h3 class="panel-title text-muted"><i class="fa fa-search fa-2x"></i> BUSQUEDA</h3>
  </div>
  <br>
  <div class="panel-body">
    <form action="<?php echo baseUrlRole() ?>centrosSolicitudesComunicacionesUbch/create" method="POST">
      <?php echo Token() ?>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <button onclick="enviar()" id="botonSubmit" type="submit" class="btn btn-lg btn-danger pull-right"><i class="fa fa-search fa-2x"></i></button>
        </div>
      </div>
    </div>
    <br>
