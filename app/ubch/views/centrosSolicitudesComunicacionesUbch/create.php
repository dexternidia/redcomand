...
<div id="panel" class="panel panel-primary">
  ...
  <div class="panel-body">
    <form action="<?php echo baseUrlRole() ?>centrosSolicitudesComunicacionesUbch" method="POST">
      <?php echo Token::field() ?>
      <?php if ($datos_cne): ?>
      <div class="row">
        <div class="col-lg-4">
          <input class="form-control" name="cedula" type="number" value="<?php echo $datos_cne->id?>" required placeholder="CEDULA">
        </div>
        <div class="col-lg-4">
          <input class="form-control" name="nombre_apellido" type="text" value="<?php echo $datos_cne->apellido_1.' '.$datos_cne->nombre_1?>" required placeholder="NOMBRE">
        </div>
        <div class="col-lg-4">
      ...
      <div class="row">
        <div class="col-lg-4">
          <input class="form-control" name="cedula" value="<?php echo $cedula ?>"" type="number" required placeholder="CEDULA">
        </div>
        <div class="col-lg-4">
          <input class="form-control" name="nombre_apellido" type="text" required placeholder="NOMBRE">
        </div>
        <div class="col-lg-4">
          <input class="form-control" name="id_ubch" type="hidden">
        </div>
        <div class="col-lg-4">
          <input class="form-control" placeholder="TELEFONO CELULAR" type="number" name="telefono" type="text">
        </div>
