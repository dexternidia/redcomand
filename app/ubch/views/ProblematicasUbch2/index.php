<div id="panel" class="panel panel-primary">
  <div class="panel-heading" style="background-color: red">
    ...
    <a class="btn btn-default pull-right" href="<?php echo baseUrlRole() ?>ProblematicasUbch2/create"><i class="fa fa-plus-square text-muted"></i><i style="color:#777;"> Agregar Problematica</i></a>    </h3>
  </div>
      ...
      <table class="table table-striped table-condensed animated fadeIn" data-striped="true">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a class="text-danger fa fa-search fa-2x" href="<?php echo baseUrlRole() ?>ProblematicasUbch2/<?php echo $p->id_problematica_ubch ?>"></a></td>
          </tr>
          <?php endforeach ?>
        </tbody>
      </table>
