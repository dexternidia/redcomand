...
class CentrosSolicitudesUbch
{
    ...
    public function update($id)
    {
       ...
       //Arr($_POST); //Array para ver que envia el formulario
        ...
        if($solicitud->save())
        {
            Success('centrosSolicitudesUbch/'.$solicitud->id_solicitud_ubch.'','Actulizada exitosamente la problematica.');
        }
        else
        {
            Error('centrosSolicitudesUbch/'.$solicitud->id_solicitud_ubch.'','Error al editar problematica.');
        }
    }
